...
__m256i inline Avx2TailMask32(const std::size_t countInDwords) noexcept {
    // countInDwords must be within [0, 8].
    alignas(32) static constexpr unsigned int tailMasks[16] = { ~0u, ~0u, ~0u, ~0u, ~0u, ~0u, ~0u, ~0u, 0, 0, 0, 0, 0, 0, 0, 0 };
    return _mm256_load_si256(reinterpret_cast<const __m256i*>(tailMasks + (8 - countInDwords)));
}

constexpr __mmask16 base_always_inline Avx512TailMask64(const std::size_t countInQWords) noexcept {
