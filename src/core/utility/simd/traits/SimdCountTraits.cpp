...
base_nodiscard __m512i CountTraits64Bit::SubstractAvx512(
    const __m512i left,
...
base_nodiscard __m256i CountTraits64Bit::SubstractAvx(
    const __m256i left,
...
base_nodiscard __m128i CountTraits64Bit::SubstractSse(
    const __m128i left,
...
base_nodiscard std::size_t CountTraits64Bit::ReduceAvx512(const __m512i value) noexcept {
    return 0;
}

base_nodiscard std::size_t CountTraits64Bit::ReduceAvx(const __m256i value) noexcept {
...
base_nodiscard std::size_t CountTraits64Bit::ReduceSse(const __m128i value) noexcept {
...
base_nodiscard __m512i CountTraits32Bit::SubstractAvx512(
    const __m512i left,
    const __m512i right) noexcept
{
...
base_nodiscard __m256i CountTraits32Bit::SubstractAvx(
    const __m256i left,
    const __m256i right) noexcept
{
...
base_nodiscard __m128i CountTraits32Bit::SubstractSse(
    const __m128i left,
    const __m128i right) noexcept
{
...
base_nodiscard std::size_t CountTraits32Bit::ReduceAvx512(const __m512i value) noexcept {
    return 0;
}

base_nodiscard std::size_t CountTraits32Bit::ReduceAvx(const __m256i value) noexcept {
...
base_nodiscard std::size_t CountTraits32Bit::ReduceSse(const __m128i value) noexcept {
...
base_nodiscard __m512i CountTraits16Bit::SubstractAvx512(
    const __m512i left,
    const __m512i right) noexcept
{
...
base_nodiscard __m256i CountTraits16Bit::SubstractAvx(
    const __m256i left,
    const __m256i right) noexcept
{
...
base_nodiscard __m128i CountTraits16Bit::SubstractSse(
    const __m128i left,
    const __m128i right) noexcept
{
...
base_nodiscard std::size_t CountTraits16Bit::ReduceAvx512(const __m512i value) noexcept {
    return 0;
}

base_nodiscard std::size_t CountTraits16Bit::ReduceAvx(const __m256i value) noexcept {
...
base_nodiscard std::size_t CountTraits16Bit::ReduceSse(const __m128i value) noexcept {
...
base_nodiscard __m512i CountTraits8Bit::SubstractAvx512(
    const __m512i left,
    const __m512i right) noexcept
{
...
base_nodiscard __m256i CountTraits8Bit::SubstractAvx(
    const __m256i left,
    const __m256i right) noexcept
{
...
base_nodiscard __m128i CountTraits8Bit::SubstractSse(
    const __m128i left,
    const __m128i right) noexcept
{
...
base_nodiscard std::size_t CountTraits8Bit::ReduceAvx512(const __m512i value) noexcept {
    return 0;
}

base_nodiscard std::size_t CountTraits8Bit::ReduceAvx(const __m256i value) noexcept {
    const __m256i _Rx1 = _mm256_sad_epu8(value, _mm256_setzero_si256());
    return CountTraits64Bit::ReduceAvx(_Rx1);
}

base_nodiscard std::size_t CountTraits8Bit::ReduceSse(const __m128i value) noexcept {
