...
NODISCARD __m256i CountTraits64Bit::SubstractAvx(
    const __m256i left,
...
NODISCARD __m128i CountTraits64Bit::SubstractSse(
    const __m128i left,
...
NODISCARD std::size_t CountTraits64Bit::ReduceSse(const __m128i value) noexcept {
#ifdef PROCESSOR_X86
...
NODISCARD __m512i CountTraits32Bit::SubstractAvx512(
    const __m512i left,
    const __m512i right) noexcept
{
...
NODISCARD __m256i CountTraits32Bit::SubstractAvx(
    const __m256i left,
    const __m256i right) noexcept
{
...
NODISCARD __m128i CountTraits32Bit::SubstractSse(
    const __m128i left,
    const __m128i right) noexcept
{
...
NODISCARD std::size_t CountTraits32Bit::ReduceSse(const __m128i value) noexcept {
...
NODISCARD __m512i CountTraits16Bit::SubstractAvx512(
    const __m512i left,
    const __m512i right) noexcept
{
...
NODISCARD __m256i CountTraits16Bit::SubstractAvx(
    const __m256i left,
    const __m256i right) noexcept
{
...
NODISCARD __m128i CountTraits16Bit::SubstractSse(
    const __m128i left,
    const __m128i right) noexcept
{
...
NODISCARD std::size_t CountTraits16Bit::ReduceSse(const __m128i value) noexcept {
...
NODISCARD __m512i CountTraits8Bit::SubstractAvx512(
    const __m512i left,
    const __m512i right) noexcept
{
...
NODISCARD __m256i CountTraits8Bit::SubstractAvx(
    const __m256i left,
    const __m256i right) noexcept
{
...
NODISCARD __m128i CountTraits8Bit::SubstractSse(
    const __m128i left,
    const __m128i right) noexcept
{
...
NODISCARD std::size_t CountTraits8Bit::ReduceSse(const __m128i value) noexcept {
