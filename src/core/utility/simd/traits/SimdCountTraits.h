...
public:
    static   __m512i SubstractAvx512(
        const __m512i left,
        const __m512i right) noexcept;
    static   __m256i SubstractAvx(
        const __m256i left,
        const __m256i right) noexcept;
    static   __m128i SubstractSse(
        const __m128i left,
        const __m128i right) noexcept;

    static   std::size_t ReduceAvx512(const __m512i value) noexcept;
    static   std::size_t ReduceAvx(const __m256i value) noexcept;
    static   std::size_t ReduceSse(const __m128i value) noexcept;
};
