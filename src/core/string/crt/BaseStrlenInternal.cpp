...
DECLARE_NOALIAS NODISCARD ZeroComparison __checkForZeroBytes(const void* start) noexcept {
	static_assert(feature == arch::CpuFeature::SSE || feature == arch::CpuFeature::AVX || feature == arch::CpuFeature::AVX512, "base::string::__checkForZeroBytes: Unsupported feature");
...
template <>
DECLARE_NOALIAS NODISCARD ZeroComparison __checkForZeroBytes<arch::CpuFeature::SSE, 1>(__m128i vector) noexcept {
...
template <>
DECLARE_NOALIAS NODISCARD ZeroComparison __checkForZeroBytes<arch::CpuFeature::SSE, 2>(__m128i vector) noexcept {
	ZeroComparison comparison;
...
template <>
DECLARE_NOALIAS NODISCARD ZeroComparison __checkForZeroBytes<arch::CpuFeature::SSE, 4>(__m128i vector) noexcept {
	ZeroComparison comparison;
...
template <>
DECLARE_NOALIAS NODISCARD ZeroComparison __checkForZeroBytes<arch::CpuFeature::AVX, 1>(__m256i vector) noexcept {
	ZeroComparison comparison;
...
template <>
DECLARE_NOALIAS NODISCARD ZeroComparison __checkForZeroBytes<arch::CpuFeature::AVX, 2>(__m256i vector) noexcept {
	ZeroComparison comparison;
...
template <>
DECLARE_NOALIAS NODISCARD ZeroComparison __checkForZeroBytes<arch::CpuFeature::AVX, 4>(__m256i vector) noexcept {
	ZeroComparison comparison;
...
template <>
DECLARE_NOALIAS NODISCARD ZeroComparison __checkForZeroBytes<arch::CpuFeature::AVX512, 1>(__m512i vector) noexcept {
	ZeroComparison comparison;
...
template <>
DECLARE_NOALIAS NODISCARD ZeroComparison __checkForZeroBytes<arch::CpuFeature::AVX512, 2>(__m512i vector) noexcept {
	ZeroComparison comparison;
...
template <>
DECLARE_NOALIAS NODISCARD ZeroComparison __checkForZeroBytes<arch::CpuFeature::AVX512, 4>(__m512i vector) noexcept {
	ZeroComparison comparison;
