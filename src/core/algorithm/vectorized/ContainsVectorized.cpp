...
//            return base::algorithm::ContainsAlgorithm<arch::CpuFeature::None>:
//:call(firstPointer, lastPointer, value);
//
//        return false;
//    }
//};
...
//                const int bingo = _mm256_movemask_epi8(_Traits_::Compare(data, comparand));
//
//                if (bingo != 0)
//                    return true;
//
...
//                        _mm256_and_si256(
//                            _Traits_::Compare(data, comparand), tailMask));
//
//                if (bingo != 0)
//                    return true;
//
...
//                const unsigned long long bingo = _Traits_::Compare(data, comparand);
//
//                if (bingo != 0)
//                    return true;
//
...
//                    _mm512_movepi8_mask(
//                        _mm512_and_si512(
//                            _mm512_movm_epi16(_Traits_::Compare(data, comparand)), _mm512_movm_epi32(tailMask)));
//
//                if (bingo != 0)
//                    return true;
//
