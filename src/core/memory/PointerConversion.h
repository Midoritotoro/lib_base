...
CONSTEXPR_ADDRESSOF NODISCARD always_inline decltype(auto)
...
template <class _PointerLikeType_>
CONSTEXPR_ADDRESSOF NODISCARD always_inline _PointerLikeType_*
    UnFancy(_PointerLikeType_* pointerLike) noexcept
{
    return pointerLike;
}
...
template <class _PossiblyNullPointerLikeType_>
CONSTEXPR_ADDRESSOF NODISCARD always_inline _PossiblyNullPointerLikeType_*
    UnfancyMaybeNull(
        _PossiblyNullPointerLikeType_* possiblyNullPointerLike) noexcept
{
    return possiblyNullPointerLike;
...
template <typename _Type_>
NODISCARD always_inline wchar_t*
...
template <typename _Type_>
NODISCARD always_inline wchar_t* CheckedToWChar(_Type_ pointerLike) noexcept
{
    const auto pointerLikeAdress = ToAddress(pointerLike);
