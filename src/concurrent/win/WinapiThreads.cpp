...
//    {
//        atomic_init(&mtx->dummy.value, 0);
//        atomic_init(&mtx->dummy.recursion, recursive ? 1 : 0);
//        atomic_init(&mtx->dummy.owner, 0);
//    }
//
...
//         */
//        return thread_id() == atomic_load_explicit(&mtx->dummy.owner,
...
//
//        while (atomic_exchange_explicit(&mtx->dummy.value, 2, std::memory_order_acquire))
//            atomic_wait(&mtx->dummy.value, 2);
//
//        restorecancel(canc);
//        atomic_store_explicit(&mtx->dummy.owner, thread_id(), std::memory_order_relaxed);
//    }
//
...
//         */
//        unsigned recursion = atomic_load_explicit(&mtx->dummy.recursion,
//            std::memory_order_relaxed);
...
//                 */
//                atomic_store_explicit(&mtx->dummy.recursion, recursion + 1,
//                    std::memory_order_relaxed);
//                return 0;
//            }
//        }
...
//        unsigned value = 0;
//
//        if (atomic_compare_exchange_strong_explicit(&mtx->dummy.value, &value, 1,
//            std::memory_order_acquire,
//            std::memory_order_relaxed)) {
//            atomic_store_explicit(&mtx->dummy.owner, thread_id(),
//                std::memory_order_relaxed);
//            return 0;
//        }
//
...
//        }
//
//        atomic_store_explicit(&mtx->dummy.owner, 0, std::memory_order_relaxed);
//
//        switch (atomic_exchange_explicit(&mtx->dummy.value, 0, std::memory_order_release)) {
//        case 2:
//            atomic_notify_one(&mtx->dummy.value);
//        case 1:
//            break;
//        default:
