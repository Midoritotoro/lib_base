...
public:
	...
	constexpr inline   Integer x() const noexcept {
		return _x;
	}

	constexpr inline   Integer y() const noexcept {
		return _y;
	}
private:
	Integer _x = 0;
...
public:
	...
	constexpr inline   Integer width() const noexcept {
		return _width;
	}

	constexpr inline   Integer height() const noexcept {
		return _height;
	}
private:
	Integer _width = 0;
...
public:
	...
	constexpr inline   Size<IntegerSize> size() const noexcept {
		return _size;
	}

	constexpr inline   Point<IntegerPoint> point() const noexcept {
		return _pointLeftXY;
	}
	...
	constexpr inline   Point<IntegerPoint> topLeft() const noexcept
	{
		return _pointLeftXY;
	}

	constexpr inline   Point<IntegerPoint> bottomRight() const noexcept
	{
		return _pointRightXY;
	}

	constexpr inline   Point<IntegerPoint> topRight() const noexcept
	{
		return Point<IntegerPoint>(_pointRightXY.x(), _pointLeftXY.y());
	}

	constexpr inline   Point<IntegerPoint> bottomLeft() const noexcept
	{
		return Point<IntegerPoint>(_pointLeftXY.x(), _pointRightXY.y());
	}

	constexpr inline   Point<IntegerPoint> center() const noexcept
	{
