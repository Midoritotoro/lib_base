...
public:
    ...
    [[nodiscard]] qsizetype indexOf(ByteArrayView a, qsizetype from = 0) const noexcept
    {
        return findByteArray(*this, from, a);
    }
    [[nodiscard]] qsizetype indexOf(char ch, qsizetype from = 0) const noexcept
    {
        return findByteArray(*this, from, ByteArrayView(&ch, 1));
    }
    ...
    [[nodiscard]] qsizetype lastIndexOf(ByteArrayView a) const noexcept
    {
        return lastIndexOf(a, size());
    }
    [[nodiscard]] qsizetype lastIndexOf(ByteArrayView a, qsizetype from) const noexcept
    {
        return lastIndexOf(*this, from, a);
    }
    [[nodiscard]] qsizetype lastIndexOf(char ch, qsizetype from = -1) const noexcept
    {
        return lastIndexOf(*this, from, ByteArrayView(&ch, 1));
    }

    [[nodiscard]] qsizetype count(ByteArrayView a) const noexcept
    {
        return count(*this, a);
    }
    [[nodiscard]] qsizetype count(char ch) const noexcept
    {
        return count(*this, ByteArrayView(&ch, 1));
    }
    ...
    inline int compare(ByteArrayView a, CaseSensitivity cs = Qt::CaseSensitive) const noexcept;
    ...
    inline int ByteArrayView::compare(ByteArrayView a, Qt::CaseSensitivity cs) const noexcept
    {
