...
#if !defined(base_declare_pure_function)
#  if defined(base_cpp_gnu) || defined(base_cpp_clang)
#    define base_declare_pure_function __attribute__((pure))
#  else
#    define base_declare_pure_function
#  endif // defined(base_cpp_gnu) || defined(base_cpp_clang)
#endif // !defined(base_declare_pure_function)


#if !defined(base_declare_const_function)
...
#    define base_declare_const_function __declspec(noalias)
#  elif defined(base_cpp_gnu) || defined(base_cpp_clang)
#    define base_declare_const_function __attribute__((const))
#  else
#    define base_declare_const_function
#  endif // defined(base_cpp_gnu) || defined(base_cpp_clang) || defined(base_cpp_msvc)
#endif // !defined(base_declare_const_function)


#if !defined(base_declare_cold_function)
#  if defined(base_cpp_gnu) || defined(base_cpp_clang)
#    define base_declare_cold_function __attribute__((cold))
#  else 
#    define base_declare_cold_function
#  endif // defined(base_cpp_gnu) || defined(base_cpp_clang)
#endif // !defined(base_declare_cold_function)
